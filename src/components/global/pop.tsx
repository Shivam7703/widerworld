...
export default function Popups() {
        ...
        >
            ...
            <div className="w-full md:w-[60%] p-8 bg-gray-50">
              ...
              {submitted ? (
                ...
                <div className='flex justify-between items-center'> <h2 className="sm:text-2xl font-medium text-xl text-gray-800">Contact Us</h2><Image src={logo} alt="logo" className="sm:w-28 w-16" /> </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-sm  font-medium text-zinc-800 uppercase">Name</label>
                      <input name="name" required onChange={handleChange} className="text-sm  w-full p-3 rounded-lg border border-gray-200 outline-none focus:ring-2 focus:ring-sky-200" placeholder="John Doe" />
                    </div>
                    <div className="space-y-1">
                      <label className="text-sm  font-medium text-zinc-800 uppercase">Phone</label>
                      <input name="phone" required onChange={handleChange} className="text-sm  w-full p-3 rounded-lg border border-gray-200 outline-none focus:ring-2 focus:ring-sky-200" placeholder="+91 00000 00000" />
                    </div>
                  </div>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <input name="email" required type="email" onChange={handleChange} className="text-sm  w-full p-3 rounded-lg border border-gray-200 outline-none focus:ring-2 focus:ring-sky-200" placeholder="john@example.com" />
                  </div>
                    <div className="space-y-1">
                    <label className="text-sm  font-medium text-zinc-800 uppercase">Country to Migrate</label>

                    <select name="country" className="text-sm  w-full p-3 rounded-lg border border-gray-200 outline-none focus:ring-2 focus:ring-sky-200 ">
                        ...
                        <option value="germany" className='text-zinc-500'>Germany</option>
                        <option value="newzealand" className='text-zinc-500'>New Zealand</option>
                        <option value="dubai" className='text-zinc-500'>Dubai</option>
                    </select>
                  </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea name="message" rows={3} onChange={handleChange} className="text-sm  w-full p-3 rounded-lg border border-gray-200 outline-none focus:ring-2 focus:ring-sky-200" placeholder="Tell us write Your Query" />
                  </div>

                  <button type="submit" className="w-full bg-gradient-to-r from-red-600 to-red-800 hover:from-blue-600 hover:to-blue-800  text-white font-medium py-3 rounded-lg transition-all shadow-lg">
                    Send Enquiry
                  </button>
                </form>
              )}
