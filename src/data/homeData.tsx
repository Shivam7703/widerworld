...
export const navigationMenu = {
  ...
  secondaryMenu: [
...

    {
      ...
      href: "#",
      subNav: [
        { id: 1, label: "AAIP", href: "/visa/Alberta PNP" },
...

    {
      ...
      href: "#",
      subNav: [
        { id: 1, label: "Canada 67 Points Calculator", href: "/visa/Canada 67 Points Calculator" },
        { id: 2, label: "Australia Points Calculator", href: "/visa/Australia Points Calculator" },
        { id: 3, label: "New Zealand Points Calculator", href: "/visa/New Zealand Points Calculator" },
      ],
    },
      ...
      subNav: [
        ...
        { id: 2, label: "Schengen Visa", href: "/visa/schengen-visa" },
        {
          ...
          subNav: [
            ...
            { id: 8, label: "Portugal", href: "/visa/Portugal Travel Visa" },
